# Ders 43: Ses ile Servo Motor ve Lamba Kontrolü 🎙️⚙️💡
...
```cpp
/*
  Ders 43-1: mBlock Ses Sensörü ile LED Kontrolü (Aç-Kapa)
*/
...
```cpp
/*
  Ders 43-2: mBlock Ses Sensörü ile Servo Motor Kontrolü
*/
...
```cpp
/*
  Ders 43-3: mBlock Ses Sensörü ve Röle ile 220V Lamba Kontrolü
*/
