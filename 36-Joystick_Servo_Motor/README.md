# Ders 36: Joystick ile Servo Motor Kontrolü 🕹️⚙️
...
```cpp
/*
  Ders 36-1: mBlock Joystick ile Bir Servo Motor Kontrolü
*/
...
```cpp
/*
  Ders 36-2: mBlock Joystick ile İki Servo Motor Kontrolü (Butonlu Sıfırlama)
*/
